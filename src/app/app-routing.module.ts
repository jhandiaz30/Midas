...
const routes: Routes = [
  ...
  {
    path: "cargardatos",
    loadChildren: "./pages/cargardatos/cargardatos.module#CargardatosPageModule",
  ...
  {
    path: "encuestaFinalizada",
    loadChildren: "./pages/encuesta/encuestas-finalizadas/encuestas-finalizadas.module#EncuestasFinalizadasModule",
  },
  {
